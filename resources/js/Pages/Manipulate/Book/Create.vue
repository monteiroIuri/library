<template>
    <app-layout title="Cadastro de Livro">
        <template #header>
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-6">
                                        ...
                                        <input type="number" name="amount" id="amount" autocomplete="amount" v-model="form.amount" class="mt-1 focus:ring-purple-500 focus:border-purple-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            submit() {
                this.form.post(this.route('manipulate.books.store'))
            }
        }
    })
</script>