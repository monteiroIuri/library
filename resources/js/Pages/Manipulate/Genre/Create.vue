<template>
    <app-layout title="Cadastro de Gênero de Livros">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Cadastro de Gênero de Livros
            </h2>
        </template>
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-6">
                                        ...
                                        <small>Breve descrição do Genero de Livros</small>
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            submit() {
                this.form.post(this.route('manipulate.genres.store'))
            }
        }
    })
</script>